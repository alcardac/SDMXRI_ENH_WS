// -----------------------------------------------------------------------
// <copyright file="OrganisationUnitSchemeImportEngine.cs" company="EUROSTAT">
...
namespace Estat.Sri.MappingStore.Store.Engine
{
    ...
    /// </summary>
    public class OrganisationUnitSchemeImportEngine : ItemSchemeImportEngine<IOrganisationUnitSchemeObject, IOrganisationUnit>
    {
        ...
        ///     The log.
        /// </summary>
        private static readonly ILog _log = LogManager.GetLogger(typeof(OrganisationUnitSchemeImportEngine));
        ...
        /// <summary>
        /// Initializes static members of the <see cref="OrganisationUnitSchemeImportEngine"/> class.
        /// </summary>
        static OrganisationUnitSchemeImportEngine()
        {
        ...
        /// </param>
        public OrganisationUnitSchemeImportEngine(Database database)
            : base(database)
        {
        }
        ...
        /// </returns>
        public override ArtefactImportStatus Insert(DbTransactionState state, IOrganisationUnitSchemeObject maintainable)
        {
            _log.DebugFormat(CultureInfo.InvariantCulture, "Importing artefact {0}", maintainable.Urn);
            var artefactStoredProcedure = _storedProcedures.InsertOrganisationUnitScheme;

// -----------------------------------------------------------------------
// <copyright file="IItemImportEngine.cs" company="EUROSTAT">
...
namespace Estat.Sri.MappingStore.Store.Engine
{
    ...
    /// </typeparam>
    public interface IItemImportEngine<in T> where T : IItemObject 
    {
        /// <summary>
        ...
        /// </returns>
        IEnumerable<long> Insert(DbTransactionState state, IEnumerable<T> items, long parentArtefact); 
    }
}
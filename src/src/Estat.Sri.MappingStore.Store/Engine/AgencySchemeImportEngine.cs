// -----------------------------------------------------------------------
// <copyright file="AgencySchemeImportEngine.cs" company="EUROSTAT">
...
namespace Estat.Sri.MappingStore.Store.Engine
{
    ...
    /// </summary>
    public class AgencySchemeImportEngine : ItemSchemeImportEngine<IAgencyScheme, IAgency>
    {
        ...
        ///     The log.
        /// </summary>
        private static readonly ILog _log = LogManager.GetLogger(typeof(AgencySchemeImportEngine));
        ...
        /// <summary>
        /// Initializes static members of the <see cref="AgencySchemeImportEngine"/> class.
        /// </summary>
        static AgencySchemeImportEngine()
        {
        ...
        /// </param>
        public AgencySchemeImportEngine(Database database)
            : base(database)
        {
        }
        ...
        /// </returns>
        public override ArtefactImportStatus Insert(DbTransactionState state, IAgencyScheme maintainable)
        {
            _log.DebugFormat(CultureInfo.InvariantCulture, "Importing artefact {0}", maintainable.Urn);
            var artefactStoredProcedure = _storedProcedures.InsertAgencyScheme;

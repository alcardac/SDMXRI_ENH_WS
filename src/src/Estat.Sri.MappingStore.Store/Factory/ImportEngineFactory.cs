// -----------------------------------------------------------------------
// <copyright file="ImportEngineFactory.cs" company="EUROSTAT">
...
namespace Estat.Sri.MappingStore.Store.Factory
{
    ...
    /// </typeparam>
    public class ImportEngineFactory<T> : IImportEngineFactory<T>
        where T : IMaintainableObject
    {
        ...
        /// The _custom method.
        /// </summary>
        private readonly Func<ConnectionStringSettings, IImportEngine<T>> _customMethod;
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ImportEngineFactory{T}" /> class.
        /// </summary>
        ...
        /// The custom Method.
        /// </param>
        public ImportEngineFactory(Func<ConnectionStringSettings, IImportEngine<T>> customMethod)
        {

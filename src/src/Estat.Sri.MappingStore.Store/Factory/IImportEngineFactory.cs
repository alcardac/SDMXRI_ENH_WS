// -----------------------------------------------------------------------
// <copyright file="IImportEngineFactory.cs" company="EUROSTAT">
...
namespace Estat.Sri.MappingStore.Store.Factory
{
    ...
    /// </typeparam>
    public interface IImportEngineFactory<in T>
        where T : IMaintainableObject
    {
        ...
        /// </returns>
        IImportEngine<T> GetEngine(ConnectionStringSettings connectionStringSettings);

// -----------------------------------------------------------------------
// <copyright file="IIdentifiableImportFactory.cs" company="EUROSTAT">
...
namespace Estat.Sri.MappingStore.Store.Factory
{
    ...
    /// </typeparam>
    public interface IIdentifiableImportFactory<in T>
        where T : IIdentifiableObject
    {
        #region Public Methods and Operators

        /// <summary>
        /// Returns the <see cref="IIdentifiableImportEngine{T}"/>.
        /// </summary>
        /// <returns>
        /// The <see cref="IIdentifiableImportEngine{T}"/>.
        /// </returns>
        IIdentifiableImportEngine<T> GetIdentifiableImport();

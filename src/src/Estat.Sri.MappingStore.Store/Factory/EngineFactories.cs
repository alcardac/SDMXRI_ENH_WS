// -----------------------------------------------------------------------
// <copyright file="EngineFactories.cs" company="EUROSTAT">
...
namespace Estat.Sri.MappingStore.Store.Factory
{
    ...
    /// </summary>
    public class EngineFactories : IEngineFactories
    {
        ...
        /// </returns>
        public IIdentifiableImportFactory<TId> GetIdentifiableFactory<TId>() where TId : IIdentifiableObject
        {
            return new IdentifiableImportFactory<TId>();
        }
        ...
        /// </returns>
        public IImportEngineFactory<T> GetMaintainableFactory<T>() where T : IMaintainableObject
        {
            return new ImportEngineFactory<T>();
        }
        ...
        /// </returns>
        public Action<IEnumerable<T>> GetMaintainableDeleteMethod<T>(ConnectionStringSettings connectionStringSettings) where T : IMaintainableObject
        {
            var deleteEngine = new DeleteEngineFactory<T>().GetDeleteEngine(connectionStringSettings);
            return deleteEngine.Delete;
        }
        ...
        /// </returns>
        public IItemImportFactory<TNam> GetNameableFactory<TNam>() where TNam : IItemObject
        {
            return new ItemImportFactory<TNam>();
        }

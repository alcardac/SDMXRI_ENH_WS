// -----------------------------------------------------------------------
// <copyright file="INameableImportFactory.cs" company="EUROSTAT">
...
namespace Estat.Sri.MappingStore.Store.Factory
{
    ...
    public interface INameableImportFactory<in T, in TProc>
        where T : INameableObject where TProc : IIdentifiableProcedure
    {
        ...
        /// </returns>
        INameableImportEngine<T, TProc> GetNameableImport();

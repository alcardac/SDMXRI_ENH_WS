...
namespace Estat.Sri.MappingStoreRetrieval.Engine
{
    ...
    internal class HierarchicalCodeListRetrievealEngine : ArtefactRetrieverEngine<IHierarchicalCodelistMutableObject>
    {
        ...
        /// <summary>
        /// The _level annotation retriever engine
        /// </summary>
        private readonly IdentifiableAnnotationRetrieverEngine _levelAnnotationRetrieverEngine;
        
        /// <summary>
        /// The _hierarchy annotation retriever engine
        /// </summary>
        private readonly IdentifiableAnnotationRetrieverEngine _hierarchyAnnotationRetrieverEngine;

        /// <summary>
        /// The _hierarchal code annotation retriever engine
        /// </summary>
        private readonly IdentifiableAnnotationRetrieverEngine _hierarchalCodeAnnotationRetrieverEngine;
            ...
            : base(mappingStoreDb)
        {
            ...
            this._hierarchalCodeAnnotationRetrieverEngine = new IdentifiableAnnotationRetrieverEngine(mappingStoreDb, new ItemTableInfo(SdmxStructureEnumType.HierarchicalCode) { ForeignKey = "H_ID", PrimaryKey = "HCODE_ID", Table = "HCL_CODE" });
            this._levelAnnotationRetrieverEngine = new IdentifiableAnnotationRetrieverEngine(mappingStoreDb, new ItemTableInfo(SdmxStructureEnumType.HierarchicalCode) { ForeignKey = "H_ID", PrimaryKey = "LEVEL_ID", Table = "HLEVEL" });
            this._hierarchyAnnotationRetrieverEngine = new IdentifiableAnnotationRetrieverEngine(mappingStoreDb, new ItemTableInfo(SdmxStructureEnumType.HierarchicalCode) { ForeignKey = "HCL_ID", PrimaryKey = "H_ID", Table = "HIERARCHY" });
        }

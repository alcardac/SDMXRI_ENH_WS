    ...
    public class AdvancedStructureRetriever : IAdvancedSdmxMutableObjectRetrievalManager
    {
        ...
        public IAgencySchemeMutableObject GetMutableAgencyScheme(IComplexStructureReferenceObject complexRef, ComplexStructureQueryDetail returnDetail)
        {
            ...
            return xref.HasVersion()
                       ? this._retrievalEngineContainer.AgencySchemeRetrievalEngine.Retrieve(xref, returnDetail.EnumType, complexRef.GetVersionConstraints()).FirstOrDefault()
                       : this._retrievalEngineContainer.AgencySchemeRetrievalEngine.RetrieveLatest(xref, returnDetail.EnumType);
        ...
        {
            var xref = complexRef.GetMaintainableRefObject();
            return this._retrievalEngineContainer.AgencySchemeRetrievalEngine.Retrieve(xref, returnDetail.EnumType, complexRef.GetVersionConstraints());
        ...
        public IContentConstraintMutableObject GetMutableContentConstraint(IComplexStructureReferenceObject complexRef, ComplexStructureQueryDetail returnDetail)
        {
            var xref = complexRef.GetMaintainableRefObject();
            return xref.HasVersion()
                       ? this._retrievalEngineContainer.ContentConstraintRetrievalEngine.Retrieve(xref, returnDetail.EnumType, complexRef.GetVersionConstraints()).FirstOrDefault()
                       : this._retrievalEngineContainer.ContentConstraintRetrievalEngine.RetrieveLatest(xref, returnDetail.EnumType);
        ...
        {
            var xref = complexRef.GetMaintainableRefObject();
            return this._retrievalEngineContainer.ContentConstraintRetrievalEngine.Retrieve(xref, returnDetail.EnumType, complexRef.GetVersionConstraints());
        ...
        public IDataConsumerSchemeMutableObject GetMutableDataConsumerScheme(IComplexStructureReferenceObject complexRef, ComplexStructureQueryDetail returnDetail)
        {
            var xref = complexRef.GetMaintainableRefObject();
            return xref.HasVersion()
                       ? this._retrievalEngineContainer.DataConsumerSchemeRetrievalEngine.Retrieve(xref, returnDetail.EnumType, complexRef.GetVersionConstraints()).FirstOrDefault()
                       : this._retrievalEngineContainer.DataConsumerSchemeRetrievalEngine.RetrieveLatest(xref, returnDetail.EnumType);
        ...
        {
            var xref = complexRef.GetMaintainableRefObject();
            return this._retrievalEngineContainer.DataConsumerSchemeRetrievalEngine.Retrieve(xref, returnDetail.EnumType, complexRef.GetVersionConstraints());
        }
        ...
        public IDataProviderSchemeMutableObject GetMutableDataProviderScheme(IComplexStructureReferenceObject complexRef, ComplexStructureQueryDetail returnDetail)
        {
            var xref = complexRef.GetMaintainableRefObject();
            return xref.HasVersion()
                       ? this._retrievalEngineContainer.DataProviderSchemeRetrievalEngine.Retrieve(xref, returnDetail.EnumType, complexRef.GetVersionConstraints()).FirstOrDefault()
                       : this._retrievalEngineContainer.DataProviderSchemeRetrievalEngine.RetrieveLatest(xref, returnDetail.EnumType);
        ...
        {
            var xref = complexRef.GetMaintainableRefObject();
            return this._retrievalEngineContainer.DataProviderSchemeRetrievalEngine.Retrieve(xref, returnDetail.EnumType, complexRef.GetVersionConstraints());

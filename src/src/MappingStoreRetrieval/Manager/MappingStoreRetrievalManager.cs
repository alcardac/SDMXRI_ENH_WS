...
namespace Estat.Sri.MappingStoreRetrieval.Manager
{
    ...
    public class MappingStoreRetrievalManager : RetrievalManagerBase
    {
        ...
        {
            return this._retrievalEngineContainer.AgencySchemeRetrievalEngine.Retrieve(xref, returnStub.GetComplexQueryDetail(), returnLatest.GetVersionConstraints());
        }
        ...
        {
            return xref.HasVersion() && !returnLatest
                       ? this._retrievalEngineContainer.ContentConstraintRetrievalEngine.Retrieve(xref, returnStub.GetComplexQueryDetail(), VersionQueryType.All).FirstOrDefault()
                       : this._retrievalEngineContainer.ContentConstraintRetrievalEngine.RetrieveLatest(xref, returnStub.GetComplexQueryDetail());
        ...
        {
            return this._retrievalEngineContainer.ContentConstraintRetrievalEngine.Retrieve(xref, returnStub.GetComplexQueryDetail(), returnLatest.GetVersionConstraints());
        }
        ...
        {
            return xref.HasVersion()
                        ? this._retrievalEngineContainer.DataConsumerSchemeRetrievalEngine.Retrieve(xref, returnStub.GetComplexQueryDetail(), VersionQueryType.All).FirstOrDefault()
                        : this._retrievalEngineContainer.DataConsumerSchemeRetrievalEngine.RetrieveLatest(xref, returnStub.GetComplexQueryDetail());
        ...
        {
            return this._retrievalEngineContainer.DataConsumerSchemeRetrievalEngine.Retrieve(xref, returnStub.GetComplexQueryDetail(), returnLatest.GetVersionConstraints());
        }
        ...
        {
            return xref.HasVersion()
                       ? this._retrievalEngineContainer.DataProviderSchemeRetrievalEngine.Retrieve(xref, returnStub.GetComplexQueryDetail(), VersionQueryType.All).FirstOrDefault()
                       : this._retrievalEngineContainer.DataProviderSchemeRetrievalEngine.RetrieveLatest(xref, returnStub.GetComplexQueryDetail());
        }
        ...
        {
            return this._retrievalEngineContainer.DataProviderSchemeRetrievalEngine.Retrieve(xref, returnStub.GetComplexQueryDetail(), returnLatest.GetVersionConstraints());
        }
        ...
        {
            return this._retrievalEngineContainer.OrganisationUnitSchemeRetrievalEngine.Retrieve(xref, returnStub.GetComplexQueryDetail(), returnLatest.GetVersionConstraints());
        }
        ...
        {
            return this._retrievalEngineContainer.StructureSetRetrievalEngine.Retrieve(xref, returnStub.GetComplexQueryDetail(), returnLatest.GetVersionConstraints());
        }

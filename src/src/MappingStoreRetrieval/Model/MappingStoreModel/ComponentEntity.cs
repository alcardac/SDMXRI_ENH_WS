...
namespace Estat.Sri.MappingStoreRetrieval.Model.MappingStoreModel
{
    ...
    public class ComponentEntity : PersistentEntityBase
    {
        ...
        /// <summary>
        /// The list of component attribute assignment groups
        /// </summary>
        private readonly Collection<GroupEntity> _attAssignmentGroups;

        /// <summary>
        /// The attribute attachment measures
        /// </summary>
        private readonly List<string> _attAttachmentMeasures;
            ...
            : base(sysId)
        {
            ...
            this._attAttachmentMeasures = new List<string>();
        }
        ...
        /// <summary>
        /// Gets the attribute attachment measures
        /// </summary>
        public IList<string> AttAttachmentMeasures
        {
            get
            {
                return this._attAttachmentMeasures;
            }
        }
